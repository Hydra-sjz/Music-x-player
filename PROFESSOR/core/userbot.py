...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Friends_Chatting_Group_Friends_0")
              
                await self.one.join_chat("PROFESSOR_NETWORK")
            except:
                pass
            assistants.append(1)
            try:
                await self.one.send_message(config.LOGGER_ID, "๏ ᴀssɪsᴛᴀɴᴛ sᴛᴀʀᴛ.........")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Friends_Chatting_Group_Friends_0")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Friends_Chatting_Group_Friends_0")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Friends_Chatting_Group_Friends_0")

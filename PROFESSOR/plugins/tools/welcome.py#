...
import asyncio
import time
from PROFESSOR.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from PROFESSOR.utils.database import get_assistant
import asyncio
from PROFESSOR.misc import SUDOERS
from PROFESSOR.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from PROFESSOR.utils.database import get_assistant, is_active_chat
...
def circle(pfp, size=(500, 500), brightness_factor=10):
    ...
    draw.ellipse((0, 0) + bigsize, fill=25)

...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("PROFESSOR/assets/font2.ttf", 30)
    font = ImageFont.truetype("PROFESSOR/assets/font.ttf", 30)
    title_font = ImageFont.truetype("PROFESSOR/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("PROFESSOR/assets/play_icons.png")
